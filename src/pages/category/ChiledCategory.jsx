...
import { deleteCategoryThunk, fetchChiledCategoryThunk, fetchSubCategoryThunk } from "../../store/categorySlice";
import Modal from "../../components/modal/Modal";
import UpdateSubCategory from "./AddSubCategory";
import AddChildCategory from "./AddChildCategory";

const ChiledCategory = () => {
    ...
    const getSubCategories = () => {
        dispatch(fetchChiledCategoryThunk({ currentPage, limit: limits, subCategoryId, search: queryTypeRef.current.value }));
    }
    ...
    const handleDeleteCategory = (categoryId) => {
            const isConfirmed = window.confirm("Are you sure you want to delete this Child Category?");
            if (isConfirmed) {
            ...
            <div className="listMain">
                ...
                <div className="searchTab">
                    ...
                    <div className="search-tab-flex">
                        <button onClick={() => setUpdatePopup({ subCategoryId })}>Add Category</button>
                        ...
                        <table className="questionsTable" frame="void" rules="none">
                            ...
                            <tbody>
                                {data?.childCategories?.length === 0 ? (
                                    ...
                                    data?.childCategories?.map((item, index) => (
                                        <tr key={index}>
                                            <td>{index + 1}</td>
                                            <td>
                ...
                {updatePopup && (
                    <Modal isOpen onClose={() => setUpdatePopup(null)}>
                        <AddChildCategory
                            ...
                            subCategoryId={subCategoryId} // Pass categoryId correctly
